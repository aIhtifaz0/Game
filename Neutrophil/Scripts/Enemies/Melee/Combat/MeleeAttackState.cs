        ...
        if (normalizedTime < 1f) {
            ...
            if(duration <= 0f){
                ...
                if(stateMachine.MeleeType == MeleeStateMachine.Melee.BossMelee) {
                    ShootAttack(stateMachine.Projectile);
                }
                ...
                if (!IsInAttackRange()) {
                    ...
                    if(stateMachine.MeleeType == MeleeStateMachine.Melee.StayMelee){
                ...
                else if(IsInAttackRange() && stateMachine.MeleeType == MeleeStateMachine.Melee.BossMelee){

                    stateMachine.SwitchState(new MeleeTransformState(stateMachine));
                }
            }
        }
