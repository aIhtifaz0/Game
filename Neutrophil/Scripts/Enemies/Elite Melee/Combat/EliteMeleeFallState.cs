...
public class EliteMeleeFallState : EliteMeleeBaseState{
    public EliteMeleeFallState(EliteMeleeStateMachine stateMachine) : base(stateMachine) {}
    ...
    public override void Enter() {
        ...
        stateMachine.Rigidbody.constraints = RigidbodyConstraints2D.None;
    ...
    public override void Exit() { 
        ...
        stateMachine.Rigidbody.constraints = RigidbodyConstraints2D.FreezePositionY;
