...
public class PlayerMainBasicAttackState : PlayerBaseState
{
    private BasicAttackData attack;
    private bool alReadyAppliedForce;
    public PlayerMainBasicAttackState(PlayerStateMachine stateMachine, int AttackIndex) : base(stateMachine) {
        
        attack = stateMachine.MainWeapon.BasicAttack[AttackIndex];
