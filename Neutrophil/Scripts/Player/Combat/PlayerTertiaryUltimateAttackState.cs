...
public class PlayerTertiaryUltimateAttackState : PlayerBaseState{

    private TertiaryUltimateAttackData attack;
    private bool alReadyAppliedForce;
    private float duration = 1f;

    public PlayerTertiaryUltimateAttackState(PlayerStateMachine stateMachine) : base(stateMachine) {

        attack = stateMachine.TertiaryWeapon.UltimateAttack;
