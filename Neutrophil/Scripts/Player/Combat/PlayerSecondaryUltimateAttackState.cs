...
public class PlayerSecondaryUltimateAttackState : PlayerBaseState{

    private SecondaryUltimateAttackData attack;
    private bool alReadyAppliedForce;
    private float duration = 1f;

    public PlayerSecondaryUltimateAttackState(PlayerStateMachine stateMachine) : base(stateMachine) {

        attack = stateMachine.SecondaryWeapon.UltimateAttack;
