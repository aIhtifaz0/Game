...
public class PlayerStateMachine : StateMachine{
    ...
    [field: SerializeField] public GameObject Main { get; private set; }
    [field: SerializeField] public GameObject Secondary { get; private set; }
    [field: SerializeField] public GameObject Spell { get; private set; }
    [field: SerializeField] public GameObject SpellAttack { get; private set; }
    [field: SerializeField] public GameObject Drop { get; private set; }
    ...
    public TertiaryWeapon TertiaryWeapon { get; private set; }

    [field: Space(20)]
    [field: SerializeField] public int Heals { get; private set; }
    [field: SerializeField] public int Ultimate { get; set; }
    ...
    private void Start(){
        ...
        MainWeapon = Main.GetComponent<MainWeapon>();
        SecondaryWeapon = Secondary.GetComponent<SecondaryWeapon>(); 
        TertiaryWeapon = Spell.GetComponent<TertiaryWeapon>();
