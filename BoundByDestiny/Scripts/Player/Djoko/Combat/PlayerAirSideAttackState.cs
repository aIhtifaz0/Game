...
public class PlayerAirSideAttackState : PlayerBaseState{
    
    private BasicAttackData attack;
    private bool alReadyAppliedForce;
    public PlayerAirSideAttackState(PlayerStateMachine stateMachine, int AttackIndex) : base(stateMachine) {
    ...
    private void TryComboAttack(float normalizedTime) {
        ...
        stateMachine.SwitchState(new PlayerAirSideAttackState(stateMachine, attack.ComboStateIndex));
    }
}
