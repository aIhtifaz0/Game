...
public class AstralStateMachine : StateMachine{

    [field: Space(20)]
    [field: SerializeField] public InputReader AstralInputReader { get; private set; }
    ...
    [field: SerializeField] public AstralForceReceiver ForceReceiver { get; private set; }
   ...
   [field: SerializeField] public BasicAttackData[] Attack { get; private set; }
    ...
    private void Start(){
        ...
        SwitchState(new AstralMainState(this));
    }
    ...
    private void HandleTakeDamage(){
        ...
        SwitchState(new AstralImpactState(this));
    }
    ...
    private void HandleDie(){
        ...
        SwitchState(new AstralDeathState(this));
    }
