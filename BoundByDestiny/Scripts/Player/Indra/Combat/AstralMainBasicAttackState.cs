...
public class AstralMainBasicAttackState : AstralBaseState{
    
    private BasicAttackData attack;
    private bool alReadyAppliedForce;
    public AstralMainBasicAttackState(AstralStateMachine stateMachine, int AttackIndex) : base(stateMachine) {
        
        attack = stateMachine.Attack[AttackIndex];
