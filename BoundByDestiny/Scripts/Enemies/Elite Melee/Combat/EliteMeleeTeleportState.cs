...
public class EliteMeleeTeleportState : EliteMeleeBaseState{
    ...
    public override void Enter() {
        ...
        stateMachine.Audio.PlaySound(stateMachine.Audio.Teleport);
        stateMachine.RanPos[0].position = stateMachine.astralStateMachine.TeleportPos[0].position;
        stateMachine.RanPos[1].position = stateMachine.astralStateMachine.TeleportPos[1].position;
        ...
        if(stateMachine.transform.position != RandomPos.position){

            Object.Instantiate(stateMachine.TeleStartVfx, stateMachine.transform.position, stateMachine.TeleStartVfx.transform.rotation);
    ...
    public override void Tick(float deltatime) {
        ...
        if(duration <= 0f){
            ...
            Object.Instantiate(stateMachine.TeleEndVfx, stateMachine.transform.position, stateMachine.TeleEndVfx.transform.rotation);
        }
    }
